...
contract Wrapper is ERC20Wrapper {
    constructor(string memory name, string memory symbol, IERC20 originalToken)
        ERC20Wrapper(originalToken)
        ERC20(name, symbol)
    {}
}
...
contract InterchainFixture is NativeStationFixture {
    ...
    function setUp() public virtual override {
        ...
        aTokenManagerERC20.addSupportedToken(
            MockTokenManagerERC20.Token(address(usdcWrapper), address(nebulaUSDC), "nebula")
        );
    }
     ...
     */
    function _bridgeToInterchain(uint256 amount, IERC20Metadata tokenA, IERC20Metadata tokenB, NativeStation station)
        internal
    {
        // 1 Approve
        ...
        LibTypesV1.TripDetails memory details =
            LibTypesV1.TripDetails(address(tokenA), address(this), amount, keccak256("nebula"));
